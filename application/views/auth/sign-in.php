...
<body id="kt_body" class="bg-body">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url(<?= base_url() ?>assets/media/illustrations/development-hd.png)">
			<!--begin::Content-->
			<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
				<!--begin::Logo-->
				<a href="../../demo5/dist/index.html" class="mb-12">
					<img alt="Logo" src="<?= base_url() ?>assets/media/logos/logo-2-dark.svg" class="h-45px" />
				</a>
				<!--end::Logo-->
				<!--begin::Wrapper-->
					...
					<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" action="#">
						...
						<div class="text-center mb-10">
							...
							<div class="text-gray-400 fw-bold fs-4">New Here?
								<a href="<?= base_url('authentication/auth/register') ?>" class="link-primary fw-bolder">Create an Account</a>
							</div>
							<!--end::Link-->
						</div>
						<!--begin::Heading-->
						...
						<div class="fv-row mb-10">
							...
							<div class="d-flex flex-stack mb-2">
								...
								<!--end::Label-->
								<!--begin::Link-->
								<a href="<?= base_url('authentication/auth/forgot_password') ?>" class="link-primary fs-6 fw-bolder">Forgot Password ?</a>
								<!--end::Link-->
							</div>
							<!--end::Wrapper-->
							<!--begin::Input-->
